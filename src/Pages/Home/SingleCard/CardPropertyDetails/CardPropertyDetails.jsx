            ...
            <div className="container flex flex-col justify-center p-2 lg:p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                ...
                <hr />
                    ...
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                        ...
                        <button className="px-8 mt-4 btn py-3 text-lg bg-gradient-to-r from-[#FD650B] to-[#FFB400] text-white font-semibold border  rounded-full dark:border-gray-800">Add to Cart</button>
