            ...
            <section className="my-24 flex flex-col lg:flex-row gap-12 rounded-xl bg-gradient-to-r from-[#FD650B] to-[#FFB400] px-16 py-24">
                ...
                <div className="flex items-center lg:pr-28">
                    <div className="space-y-5">
                        ...
                        <p className="text-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which do not look even slightly believable.</p>
                        <button className="btn bg-white">Show All</button>
                    </div>
                </div>
